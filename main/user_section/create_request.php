<?php
  ...
  $_SESSION["create_request_type"] = "request";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"> Create Supply/Equipment Request</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="content">
                    <div class="container">
                        ...
                        <?php
                                    ...
                                    $m = DB::run("INSERT INTO request(uid, request_no, request_purpose, total_supplies_requested, total_equipments_requested) VALUES(?, ?, ?, ?, ?)", [$_SESSION["uid"], $request_no, $request_purpose, $totalSupplies, $totalEquipments]);
